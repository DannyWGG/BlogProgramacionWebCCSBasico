...
?>
            ...
            <div class="formuReg">
                <a href="../FuncionesInfo/modificar.php?id=<?php echo $_SESSION['id']; ?>">Editar Perfil</a>
            </div>
        ...
        <div class="RegiPrincipal FuenteYColorNav">
            <div class="formuReg">
                ...
                <form method="POST" action="UpdatePost.php?id=<?php echo $id;?>" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="formuReg">
						<input type="text" id="titulo" name="titulo" placeholder="Nombre" value="<?php echo $row['titulo']; ?>" required>
					</div>
				</div>
                                <div>
					<label for="nombre">Post</label>
					<div class="formuReg">
						<input type="text"id="post" name="post" placeholder="Nombre" value="<?php echo $row['post']; ?>" required>
					</div>
				</div>
